...
#define _IridescenceMaskScale               UNITY_ACCESS_DOTS_INSTANCED_PROP_WITH_DEFAULT(float  , _IridescenceMaskScale)
#define _IridescenceThickness               UNITY_ACCESS_DOTS_INSTANCED_PROP_WITH_DEFAULT(float  , _IridescenceThickness)
#define _IridescenceThicknessRemap          UNITY_ACCESS_DOTS_INSTANCED_PROP_WITH_DEFAULT(float4 , _IridescenceThicknessRemap)

#define _Thickness                          UNITY_ACCESS_DOTS_INSTANCED_PROP_WITH_DEFAULT(float  , _Thickness)
#define _Curvature                          UNITY_ACCESS_DOTS_INSTANCED_PROP_WITH_DEFAULT(float  , _Curvature)
#define _ThicknessCurvatureRemap            UNITY_ACCESS_DOTS_INSTANCED_PROP_WITH_DEFAULT(float4 , _ThicknessCurvatureRemap)
#define _TransmissionScale                  UNITY_ACCESS_DOTS_INSTANCED_PROP_WITH_DEFAULT(float  , _TransmissionScale)

#define _DiffusionColor                     UNITY_ACCESS_DOTS_INSTANCED_PROP_WITH_DEFAULT(float4 , _DiffusionColor)
#define _TransmissionScale                  UNITY_ACCESS_DOTS_INSTANCED_PROP_WITH_DEFAULT(float  , _TransmissionScale)
#define _TranslucencyScale                  UNITY_ACCESS_DOTS_INSTANCED_PROP_WITH_DEFAULT(float  , _TranslucencyScale)
...
#define _TranslucencyDiffuseInfluence       UNITY_ACCESS_DOTS_INSTANCED_PROP_WITH_DEFAULT(float  , _TranslucencyDiffuseInfluence)
...
#define _HueShift                           UNITY_ACCESS_DOTS_INSTANCED_PROP_WITH_DEFAULT(float  , _HueShift)
#endif